...
router.put('/transcript-requests/:institutionId/:requestId', adminController.respondToTranscriptRequest);


router.put('/progress-requests/:institutionId/:requestId', adminController.approveProgressRequest);
